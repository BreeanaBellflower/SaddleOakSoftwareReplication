...
const WhatPeopleSay = () => {
    return <>
            <div className="what-people-say">
                ...
                <div className="section-previews review-previews">
                    <div className="column-card review-card">
                        <div className="card-image-container">
                            <img src={process.env.PUBLIC_URL + '/images/review1.webp'} alt="chuck" />
                        </div>
                        <div className="review-card-description">
                            ...
                            <div className="review-content">
                                <p>...extremely helpful in rectifying and assisting with any challenge. A really great team!!!</p>
                            </div>
                    ...
                    <div className="column-card review-card">
                    <div className="card-image-container">
                            <img src={process.env.PUBLIC_URL + '/images/review2.webp'} alt="Joan" />
                        </div>
                        <div className="review-card-description">
                            <svg preserveAspectRatio="xMidYMid meet" data-bbox="0 19.7 200 161.209" xmlns="http://www.w3.org/2000/svg" viewBox="0 19.7 200 161.209" role="img">
                                <g>
                            ...
                            <div className="review-content">
                                <p>Support staff is very helpful and responds quickly.</p>
                            </div>
                            <div className="review-signature">
                                <h5>- Joan</h5>
                                <p>Beantown Bedding</p>
                            </div>
                        </div>
                    </div>
                    <div className="column-card review-card">
                    <div className="card-image-container">
                            <img src={process.env.PUBLIC_URL + '/images/review3.webp'} alt="Joanne" />
                        </div>
                        <div className="review-card-description">
                            <svg preserveAspectRatio="xMidYMid meet" data-bbox="0 19.7 200 161.209" xmlns="http://www.w3.org/2000/svg" viewBox="0 19.7 200 161.209" role="img">
                                <g>
                            ...
                            <div className="review-content">
                                <p>Customer support is fantastic. The software is continually being improved.</p>
                            </div>
                            <div className="review-signature">
                                <h5>- Joanne</h5>
                                <p>Lakota Herbs</p>
